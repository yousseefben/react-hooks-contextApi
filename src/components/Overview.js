...
import './overview.css'
import TopDriver from './Card/TypeTrips';
                ...
                <Row style={{marginTop: 30}}>
                    <Col span={11}>
                           <Card>
                               ...
                               <Row style={{marginTop: 16}}>
                                <Text style={{fontSize: 32, lineHeight:1.1, fontWeight: '300'}}>1,428 cars</Text>
                               </Row>
                    ...
                    <Col span={11} offset={2}>
                         <Card>
                               ...
                               <Row style={{marginTop: 16}}>
                                <Text style={{fontSize: 32, lineHeight:1.1, fontWeight: '300'}}>158.3 mi</Text>
                               </Row>
                               <Row style={{paddingBottom: 16, marginTop: 10}}>
